            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Detenteurs</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Detenteurs</h2>
                </div>
              </div>
            </div>
          </div>
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel"
                            ><i data-feather="user" class="icon-svg-primary wid-20 me-2"></i><span id="titledetenteurs">Detenteurs</span></h5
                          >
                          ...
                          <div class="modal-body">
                            ...
                            <div class="mb-3">
                              ...
                              <input
                                type="text"
                                class="form-control"
                                id="libelledetenteurs"
                                name="libelledetenteurs"
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  $('#report-table').DataTable({
      ...
      processing: true,
        ...
        ajax: '{{ route("afficherdetenteurs") }}', // Fetch data via AJAX
    ...
    buttons: [
        {
            ...
            title: 'Liste des Detenteurs'
        }
    ],
        columns: [
            {data: 'id', name: 'id'}, 
            {data: 'libelledetenteurs', name: 'libelledetenteurs'}, // Famille name
  ...
  <script>
     ...
     $('#deteteursForm').submit(function(e) {
            e.preventDefault();
            var id = $('#idlib').val();
            var url = (id) ? '/updatedetenteur/' + id : '/detenteuri/';
...
if (response.success) {
  ...
  alert(response.message); // Afficher un message de succès
    ...
    $('#report-table').DataTable().ajax.reload();
                ...
                error: function(error) {
                   ...
                   // alert('An error occurred.');
                    ...
                    if (errors.libelledetenteurs) {
                      ...
                      alert(errors.libelledetenteurs[0]);
                    }
                }
                }
            });
      ...
      $('body').on('click', '.deletedetenteur', function() {
        var id = $(this).data('id');
        var name = $(this).data('name');
        var url = '/suppdetenteur/' + id;
  ...
  cancelButtonText:"Annuler",
   ...
   $.ajax({
    ...
    Swal.fire("Aucune Modification n'a été apportée", "", "info");
       ...
       $('body').on('click', '.rollbackdetenteur', function() {
        var id = $(this).data('id');
        var name = $(this).data('name');
        var url = '/rollbackdetenteur/' + id;
  ...
  cancelButtonText:"Annuler",
    ...
    Swal.fire("Aucune Modification n'a été apportée", "", "info");
      ...
      $('body').on('click', '.editdetenteur', function () {
        var id = $(this).data('id');
        
 


       $.get('/getdetenteurpar/' + id, function (data) {
            // Populate the modal form with the fetched data
           // alert(data.libelefamille);
           $('#titledetenteurs').html('Modifier Libelle Detenteur'); 
           $("#idlib").val(id);
            $('#libelledetenteurs').val(data.libelledetenteurs);
      ...
      $("#buttonshowmodal").on('click',function(){
            ...
            $('#titledetenteurs').html('Detenteurs'); 
           $("#idlib").val("");
