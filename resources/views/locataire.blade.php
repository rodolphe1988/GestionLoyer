...
<!-- [ Header ] end -->
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Locataires</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Locataires</h2>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card shadow-none">
              <div class="card-header">
                ...
                <div class="card-header-right">
                  ...
                  <button type="button" class="btn btn-primary"  id="showdialog" >
   ...
   <div class="mb-3">
       ...
       <input class="form-control" id="numappartementupdate" type="hidden" aria-describedby="idlib" name="numappartementupdate">

                            </div> 
                         
                           <div class="mb-3">
                            <label for="montantcautionp" class="form-label" style="color:red;" >Montant Caution A Payer</label>
                            <input type="text" class="form-control" name="montantcautionp" id="montantcautionp" value="" placeholder="Caution A payer" style="color:red;" readonly />
                               
                        </div>
                             <div class="mb-3">
                            <label for="nom" class="form-label">Nom</label>
                            <input type="text" class="form-control" name="nom" id="nom" value="" placeholder="Saisissez le nom" required />
                               
                        </div>

                            <div class="mb-3">
                            <label for="typelocation" class="form-label">Prenom</label>
                           <input type="text" class="form-control" name="prenom" id="prenom" value="" placeholder="Saisissez le prenom" required />
              ...
              <label class="form-label" for="nbmremoiscaution" >Adresse Mail</label>
                         <input type="email" name="email" id="email" class="form-control" data-bouncer-message="The domain portion of the email address is invalid (the portion after the @)."  aria-describedby="bouncer-error_email" aria-invalid="true">
                            </div>
                             <div class="mb-3">
                            <label for="typelocation" class="form-label">Profession</label>
                           <input type="text" class="form-control" name="poste" id="poste" value="" placeholder="Saisissez le Poste" required />

                        </div> 

                            <div class="mb-3">
                            <label for="typelocation" class="form-label">Montant Caution Versé</label>
                           <input type="text" class="form-control" name="montantcaution" id="montantcaution" value="" placeholder="Saisissez le Montant" required />

                        </div> 

                           <div class="mb-3">
                            <label for="typelocation" class="form-label">Date Entrée Locataire</label>
                           <input type="date" class="form-control" name="dateentree" id="dateentree" value="" style="padding: 0.6em 0.75rem !important;height:45px;" placeholder="Selectionner Date Entree" required />
                            ...
                            <label for="typelocation" class="form-label">Date Enregistrement Locataire</label>
                           <input type="date" class="form-control" name="dateenregloc" id="dateenregloc" value="" style="padding: 0.6em 0.75rem !important;height:45px;" placeholder="Selectionner Date Enregistrement Locataire" required />

                        </div> -->

                         <div class="mb-3">
                            <label for="typelocation" class="form-label">Date Sortie Locataire</label>
                           <input type="date" class="form-control" name="datesortie" id="datesortie" value="" style="padding: 0.6em 0.75rem !important;height:45px;" placeholder="Selectionner Date Sortie"  />
                  ...
                  >
                    <div class="modal-dialog" role="document" >
                      ...
                      <tr>
                        ...
                        <tr>
                        <th class="border-top-0" style="text-transform: none !important;"> Montant Caution : </th>
                        <th class="border-top-0" style="text-transform: none !important;"><span id="montantcautiond" ></span></th>
                      </tr>
                        <tr>
                  ...
                  <table id="report-table" class="table table-bordered table-striped mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="border-top-0" style="text-transform: none !important;">Prenom</th>
                        <th class="border-top-0" style="text-transform: none !important;">Numero</th>
                        <th class="border-top-0" style="text-align:center;text-transform: none !important;">Montant Caution</th>
                        <th class="border-top-0" style="text-align:center;text-transform: none !important;">Reliquat Caution</th>
                        <th class="border-top-0" style="text-align:center;text-transform: none !important;">Date Entree</th>
...
<script>
   ...
   document.getElementById("montantcaution").addEventListener("input", function (e) {
   ...
   document.getElementById("montantcautionp").addEventListener("input", function (e) {
       this.value = this.value.replace(/[^0-9]/g, ""); // Allow only digits
   });
      /*document.getElementById("nbmremoiscaution").addEventListener("input", function (e) {
       this.value = this.value.replace(/[^0-9]/g, ""); // Allow only digits
  ...
  $('#report-table').DataTable({
    ...
    responsive: true,
      ...
      // <-- LANGUAGE GOES HERE -->
         ...
         ajax: '{{ route("afficherlocataire") }}', // Fetch data via AJAX
    ...
    //'iddenomination','numappartement','nom','prenom','numero1','numero2','adresseemail','occupation','montantcaution','dateentree','datesortie','reliquatcaution'
        columns: [
            ...
            {data: 'numero1', name: 'numero1'},
            //{data: 'adresseemail', name: 'adresseemail'},
            {data: 'montantcaution', name: 'montantcaution'},
            {data: 'reliquatcaution', name: 'reliquatcaution'},
            ...
            {data: 'is_sorti', name: 'is_sorti', visible: false}
        ],
        createdRow: function (row, data, dataIndex) {
        if (data.is_sorti == 1) {
            $(row).css('background-color', 'lightgreen');   // rouge pâle
            $(row).css('color', '#b30000');              // texte légèrement rouge
        }
    },
         language: {
                    searchBuilder: {
...
var url = '/getdetails/' + denomination+'/'+numappartement;
 ...
 $.ajax({
           ...
           //alert(response.montantcaution);
             
                    $("#montantcautionp").val(""+response.montantcaution);

                    $("#montantcaution").val(""+response.montantcaution);
...
$.each(response, function(key, value) {
       ...
       $('#deteteursForm').submit(function(e) {
           ...
           var id = $('#idlib').val();
            var url = (id) ? '/updatelocataire/' + id : '/locatairei/';
  ...
  if (result.isConfirmed) {
    ...
    Swal.fire("Aucune Modification effectuée!!", "", "success");
     ...
     //   }
      ...
      // $.get('/getlocatairepar/' + id, function (data) {
        $.get('/getlocatairesecondpar/'+ id+'/'+numappart, function (data) {
            // Populate the modal form with the fetched data
           // alert(data.libelefamille);
        $("#idlib").val(id);
            $('#titlemaison').html('Modifier Locataire'); 
            $('#denomination').val(data.locataire.iddenomination);
            //$('#numappartement').val(data.numappartement);


           // alert(data.numappartement);
var idappart=data.locataire.numappartement;
    ...
    data.appartements.forEach(function(appart) {
       if(appart.numappartement==idappart){
        ...
        $('#numappartementupdate').val(appart.numappartement);
      }
       else{
    ...
    $('#numappartement').prop("disabled",true);
//alert(data.appartcaution.montanttotalcaution);
     $('#montantcautionp').val(data.appartcaution.montanttotalcaution);
...
// Exemple: l'indicatif récupéré depuis la BD
var countryCode = "+225"; // À

// Mapper les indicatifs téléphoniques vers les codes pays
...
if(data.locataire.numero1 &&
  typeof data.locataire.numero1 === 'string' &&
  data.locataire.numero1.trim() !== ''){
const parsedNumber = libphonenumber.parsePhoneNumberFromString(data.locataire.numero1);


        
        if (parsedNumber) {
          // Afficher l'indicatif
          countryCode = parsedNumber.countryCallingCode; // Indicatif
...
const initialCountry = countryDialCodes[countryCode] || "ci"; // "ci" par défaut
...
iti.setNumber(data.locataire.numero1);

$("#phone_full1").val(data.locataire.numero1);
}

if( data.locataire.numero2 &&
  typeof data.locataire.numero2 === 'string' &&
  data.locataire.numero2.trim() !== ''){

const parsedNumber2 = libphonenumber.parsePhoneNumberFromString(data.locataire.numero2);


        
        if (parsedNumber2) {
          // Afficher l'indicatif
          countryCode = parsedNumber2.countryCallingCode; // Indicatif
...
// Trouver le code pays correspondant
const initialCountry2 = countryDialCodes[countryCode] || "ci"; // "ci" par défaut


const input2 = document.querySelector("#phone2");
const iti2 = window.intlTelInput(input2, {
  separateDialCode: true,
  initialCountry:initialCountry2, // Côte d'Ivoire
   hiddenInput: () => ({ phone: "phone_full2", country: "country_code2" }),
});
iti2.setNumber(data.locataire.numero2);

$("#phone_full2").val(data.locataire.numero2);
...
$("#phone_full2").val(contact2);
           ...
           $("#idlib").val("");
            ...
            $("#dateentree").val("");
            $('#numappartdisa').val("");
             $('#numappartement').prop("disabled",false);
             $("#numappartdisa").prop("disabled", true);
...
*/
                  ...
                  $("#numeroappart").html(response.numappart);
                    ...
                    $("#montantcautiond").html(response.montantcaution);
