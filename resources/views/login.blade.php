    ...
    <div class="auth-main">
      <div class="auth-wrapper v2">
        <div class="auth-sidecontent">
          <img src="{{ asset('assets/images/authentication/imgloyergest.webp') }}" alt="images" class="img-fluid img-auth-side" />
        </div>
        <div class="auth-form">
          <div class="card my-5">
            <div class="card-body">
              <div class="text-center" style="display:none;">
                ...
                <div class="d-grid my-3">
                  <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted">
                    <img src="{{ asset('assets/images/authentication/facebook.svg')}}" alt="img" /> <span> Sign In with Facebook</span>
                  </button>
                  <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted">
                    <img src="{{ asset('assets/images/authentication/twitter.svg') }}" alt="img" /> <span> Sign In with Twitter</span>
                  </button>
                  <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted">
                    <img src="{{ asset('assets/images/authentication/google.svg') }}" alt="img" /> <span> Sign In with Google</span>
                  </button>
                </div>
              </div>
               <div class="text-center">
            <img src="{{ asset('assets/images/gestloyerlogo.png') }}" alt="img" style="width:55%;height:55%;" /></a>
              </div>
              <div class="saprator my-3">
                <span>Authentification</span>
                  ...
                  <form  method="post" action="{{ route('login') }}">
                          @csrf 
              <h4 class="text-center f-w-500 mb-3" style="display:none;">Login with your email</h4>
              <div class="mb-3">
                <input type="email" class="form-control" id="floatingInput" name="loginUsername" placeholder="Email Address" required />
              </div>
              <div class="mb-3">
                <input type="password" class="form-control" id="floatingInput1"  name="loginPassword" placeholder="Password" required />
              </div>
                @if ($errors->has('login'))
...
@endif
              <div class="d-flex mt-1 justify-content-between align-items-center">
                <div class="form-check">
                  ...
                  <label class="form-check-label text-muted" for="customCheckc1">Memoriser Parametres?</label>
                </div>
              ...
              <div class="d-grid mt-4">
                <button type="submit" class="btn btn-primary" style="border-radius: 5px;" >Se Connecter</button>
              </div>
            </form>
              <div class="d-flex justify-content-between align-items-end mt-4" style="display:non !important;">
                <h6 class="f-w-500 mb-0" style="visibility:hidden;" >Don't have an Account?</h6>
