 <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="javascript:void(0);" class="pc-link">
            ...
            <span class="pc-mtext">Parametres</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
            <span class="pc-badge" style="display:none;">2</span>
          </a>
          <ul class="pc-submenu">
             <li class="pc-item"><a class="pc-link" href="{{ route('detenteur') }}">Detenteurs</a></li>
             <li class="pc-item"><a class="pc-link" href="{{ route('typeappartement') }}">Type Appartement</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('construction') }}">Type Immobilier</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('typelocation') }}">Type Location</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('modepaiement') }}">Mode paiement</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('autre') }}">Autres</a></li>
            <!--<li class="pc-item"><a class="pc-link" href="../dashboard/membership-list.html">Equipements</a></li>
            <li class="pc-item"><a class="pc-link" href="../dashboard/analytics.html">Bordereau Prix</a></li>
            <li class="pc-item"><a class="pc-link" href="../dashboard/finance.html">Autres Parametres</a></li> -->
          </ul>
        </li>
        ...
        <li class="pc-item pc-hasmenu ">
          <a href="javascript:void(0);" class="pc-link">
            ...
            <span class="pc-mtext">Enregistrement</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
          </a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="{{ route('patrimoine') }}">Patrimoine Immobilier</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('appartement') }}" style="display:;">Appartement</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('locataire') }}" style="display:;" >Locataire</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('travaux') }}" style="display:;" >Travaux Maison</a></li>

            <li class="pc-item"><a class="pc-link" href="../demo/layout-compact.html" style="display:none;" >Compact</a></li>
            <li class="pc-item"><a class="pc-link" href="../demo/layout-tab.html" style="display:none;">Tab</a></li>
          </ul>
        </li>
          ...
          <ul class="pc-submenu">
             <li class="pc-item"><a class="pc-link" href="{{ route('paiementloyer') }}">Paiement Loyer</a></li>
            <!--   <li class="pc-item"><a class="pc-link" href="{{ route('typeappartement') }}">Type Appartement</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('construction') }}">Type Immobilier</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('typelocation') }}">Type Location</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('modepaiement') }}">Mode paiement</a></li>
        ...
        <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
             <li class="pc-item"><a class="pc-link" href="{{ route('fluxsortant') }}">Sortants</a></li>
            <!--   <li class="pc-item"><a class="pc-link" href="{{ route('typeappartement') }}">Type Appartement</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('construction') }}">Type Immobilier</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('typelocation') }}">Type Location</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('modepaiement') }}">Mode paiement</a></li>
