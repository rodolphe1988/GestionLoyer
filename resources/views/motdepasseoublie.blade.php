...
<link rel="stylesheet" href="{{ asset('ssets/fonts/feather.css') }}" />
...
<link rel="stylesheet" href="ass{{ asset('ets/css/style-preset.css') }}" />
    ...
    <div class="auth-main">
      <div class="auth-wrapper v1">
        <div class="auth-form">
          <div class="card my-5">
            <div class="card-body">
              <a href="#" style="display:none;"><img src="{{ asset('assets/images/logo-dark.svg')}}" class="mb-4 img-fluid" alt="img" /></a>
              <div class="d-flex justify-content-between align-items-end mb-4">
                <h3 class="mb-0"><b>Mot de passe oublié</b></h3>
                <a href="{{ route('login')}}" class="link-primary">Page de Connexion</a>
              </div>
              <div class="mb-3">
