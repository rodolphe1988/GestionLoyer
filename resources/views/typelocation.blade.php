            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Type Location</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Type Location</h2>
                </div>
              </div>
            </div>
          </div>
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel"
                            ><i data-feather="user" class="icon-svg-primary wid-20 me-2"></i><span id="titletypelocation">Type Location</span></h5
                          >
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                        </div>
                      <form id="typelocationForm" method="post">
                            @csrf
                          <div class="modal-body">
                            ...
                            <div class="mb-3">
                              ...
                              <input
                                type="text"
                                class="form-control"
                                id="libelletypelocation"
                                name="libelletypelocation"
 ...
 // import { DataTable } from '/assets/js/plugins/module.js';
  ...
  $('#report-table').DataTable({
      ...
      processing: true,
        ...
        ajax: '{{ route("affichertypelocation") }}', // Fetch data via AJAX
    ...
    buttons: [
        {
            ...
            title: 'Liste Type Location'
        }
    ],
        columns: [
            {data: 'id', name: 'id'}, 
            {data: 'libelletypelocation', name: 'libelletypelocation'}, // Famille name
...
alert(response);
  ...
  <script>
     ...
     $('#typelocationForm').submit(function(e) {
            e.preventDefault();
            var id = $('#idlib').val();
            var url = (id) ? '/updatetypelocation/' + id : '/typelocationi/';
         ...
         $.ajax({
                ...
                success: function(response) {
                    ...
                    /*alert(''+message);
                     ...
                     $('#typelocationForm')[0].reset(); // Réinitialiser le formulaire
    ...
    $('#report-table').DataTable().ajax.reload();
                ...
                error: function(error) {
                   ...
                   // alert('An error occurred.');
                    ...
                    if (errors.libelletypelocation) {
                        //$('#error-libelletypelocation').text(errors.libelletypelocation[0]); // Afficher l'erreur sous l'input

                      alert(errors.libelletypelocation[0]);
                    }
                }
                }
            });
      ...
      $('body').on('click', '.deletetypelocation', function() {
        var id = $(this).data('id');
        var name = $(this).data('name');
        var url = '/supptypelocation/' + id;
      ...
      // alert(name);
       ...
       $('body').on('click', '.rollbacktypelocation', function() {
        var id = $(this).data('id');
        var name = $(this).data('name');
        var url = '/rollbacktypelocation/' + id;
      ...
      $('body').on('click', '.edittypelocation', function () {
        var id = $(this).data('id');
        
 


       $.get('/gettypelocationpar/' + id, function (data) {
            // Populate the modal form with the fetched data
           // alert(data.libelefamille);
           $('#titletypelocation').html('Modifier Libelle Type Location'); 
           $("#idlib").val(id);
            $('#libelletypelocation').val(data.libelletypelocation);
      ...
      $("#buttonshowmodal").on('click',function(){
            ...
            $('#titletypelocation').html('Type Location'); 
           $("#idlib").val("");
            $('#libelletypelocation').val("");
